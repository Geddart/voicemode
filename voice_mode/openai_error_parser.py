...
class OpenAIErrorParser:
    ...
    ERROR_MESSAGES = {
        'quota_exceeded': {
            ...
            'fallback': 'You can use local voice services (Kokoro) which don\'t require API credits.'
        },
        'auth_failed': {
            ...
            'fallback': 'You can use local voice services (Kokoro) without an API key.'
        },
        'rate_limit': {
            ...
            'fallback': 'Local services (Kokoro) have no rate limits.'
        },
        'billing_limit': {
        ...
        'access_terminated': {
            ...
            'fallback': 'Use local voice services (Kokoro) instead.'
        },
        'invalid_request': {
